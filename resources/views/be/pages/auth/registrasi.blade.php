                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <div class="text-center">
                                    ...
                                    <p>Glad to see you again <br>Buat Akun to your account below</p>
                                </div>
                                @include('be.layouts.app_session')
                                <form action="{{ route('auth.act_registrasi') }}" method="post">
                                    @csrf
                                    <div class="mb-3">
                                    ...
                                    <button type="submit"
                                        ...
                                        Akun</button>
                                    <div class="text-center">
                                        <p class=" fw-bold">Already have an account?
